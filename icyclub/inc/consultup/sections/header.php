...
if ( ! function_exists( 'icycp_consultup_header' ) ) :
  ...
  <?php 
      $consultup_head_info_icon_one = get_theme_mod('consultup_head_info_icon_one','fa-clock-o');
   ...
   <div class="col-md-9 col-sm-8">
            <div class="header-widget row">
              <div class="col-md-3 offset-md-3 col-sm-3 col-xs-6 hidden-sm hidden-xs">
                <div class="ti-header-box">
                  <div class="ti-header-box-icon">
                    <?php $consultup_header_widget_one_icon = get_theme_mod('consultup_header_widget_one_icon','fa-clock-o');
              ...
              <div class="col-md-3 col-sm-6 col-xs-6 hidden-sm hidden-xs">
                <div class="ti-header-box">
                  <div class="ti-header-box-icon">
                    <?php $consultup_header_widget_two_icon = get_theme_mod('consultup_header_widget_two_icon','fa-envelope-o');
