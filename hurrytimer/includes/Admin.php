...
?>
        <div class="notice notice-info is-dismissible">
            ...
            <p> <a href="https://wordpress.org/support/plugin/hurrytimer/reviews/?filter=5" class="button-primary">Leave a review</a>
                &nbsp;<button type="button" class="button button-default" id="hurryt-remind-review-notice">Remind me later</a>
                    &nbsp; <button type="button" class="button-link" id="hurryt-dismiss-review-notice" style="margin-left:10px">Already done!</a>
