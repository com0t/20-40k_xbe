        ...
        <div class="oxi-addons-row">
            ...
            foreach ($this->TEMPLATE as $key => $value) {
                ...
                if (array_key_exists($this->effects . '-' . $key, $this->activated_template)) :
                    ?>
                    <div class="oxi-addons-col-1" id="<?php echo $this->effects . '-' . $key; ?>">
                            ...
                            <div class="oxi-addons-style-preview-top oxi-addons-center">
                                ...
                                foreach ($value as $filename) {
                                    ...
                                    if (is_file($folder . $filename)) {
                                        ...
                                        echo ' <input type="hidden" id="oxi-template-' . $key . '-data-' . $i . '" name="custId" value="' . 'Modules/' . ucfirst($this->effects) . '/Layouts/' . $key . '/' . $filename . '">';
                                        echo '</div>';
                                        $i++;
                                    }
                                }
                ...
                <?php echo ucfirst($this->effects); ?>
                                ...
                                <div class="oxi-addons-style-preview-bottom-right">
                                    <button class="btn btn-warning oxi-addons-addons-style-btn-warning" title="Delete" data-value="<?php echo $key; ?>" data-effects="<?php echo $this->effects; ?>" type="button" value="Deactive">Deactive</button>
                                    <button type="button" class="btn btn-success oxi-addons-addons-template-create" effects-data="oxi-template-<?php echo $key; ?>">Create Style</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            if (!array_key_exists($this->effects . '-' . $key, $this->activated_template)) :
                ...
                if (apply_filters('oxi-image-hover-plugin-version', false) == true || array_key_exists($this->effects . '-' . $key, $this->pre_clecked)) :
                    ?>
                                        ...
                                        ?>
                                        <button class="btn btn-danger" title="Premium Templates" type="button" value="Premium Templates" name="styleactive<?php echo $key; ?>">Premium Templates</button>
                                    <?php
                                    endif;
                                    ?>
                                </div>
