...
class Admin extends Base {
	...
	public function enqueue_scripts() {
		...
		$localized = array(
			...
			'analyze'		=> __( 'Analyze', 'image-sizes-pro' ),
			'analyzing'		=> __( 'Analyzing..', 'image-sizes-pro' ),
			'analyzed'		=> __( 'Analyzed', 'image-sizes-pro' ),
			'optimize'		=> __( 'Optimize', 'image-sizes-pro' ),
			'optimizing'	=> __( 'Optimizing..', 'image-sizes-pro' ),
			'optimized'		=> __( 'Optimized', 'image-sizes-pro' ),
		);
